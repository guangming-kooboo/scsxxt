...
namespace Qx.Tools
{
    ...
    {
        private static string AutoAddZero(int num)
        {
        ...
        public static string DataString
        {
            get
            {
                ...
                var Year = time.Year;
                var Month = AutoAddZero(time.Month);
                var Day = AutoAddZero(time.Day);
                var Hour = AutoAddZero(time.Hour);
                var Minute = AutoAddZero(time.Minute);
                var Second = AutoAddZero(time.Second);
