            ...
            string tipString = "", bool readOnly = false)
        {
            ...
            dest.Append(readOnly
                ? htmlHelper.DropDownListFor(expression, selectList,
                    new {@class = "form-control", @readonly = "readonly", id = htmlHelper.NameFor(expression).ToString() })
                : htmlHelper.DropDownListFor(expression, selectList, new {@class = "form-control",id= htmlHelper.NameFor(expression).ToString() }));
