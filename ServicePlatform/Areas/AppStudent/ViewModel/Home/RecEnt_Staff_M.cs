...
{
    public class RecEnt_Staff_M : BaseViewModel
    {
        public static RecEnt_Staff_M ToViewModel( string EntPracNo, int VolunteerSequence, int PosSequence, List<DownLoadFiles> DownLoadFiles)
        {
