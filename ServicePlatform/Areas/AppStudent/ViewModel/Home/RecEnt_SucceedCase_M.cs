...
{
    public class RecEnt_SucceedCase_M : BaseViewModel
    {
        public static RecEnt_SucceedCase_M ToViewModel( string EntPracNo, int VolunteerSequence, int PosSequence, List<DownLoadFiles> DownLoadFiles)
        {
