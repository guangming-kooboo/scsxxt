...
using ServicePlatform.ViewModels.Report;
...
namespace ServicePlatform.Controllers
{
    public class ReportController : BaseController
    {
        ...
        public ActionResult Report(string ReportID, string Params, string ExtraParam, string AddLink, string Title, int pageIndex, int perCount, List<List<string>> dataSource)
        {
